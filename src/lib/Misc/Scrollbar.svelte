<script lang="ts">
	...
	const tabsSvelte4 = [
		{
			title: 'app.css',
			code: `/* Works on Chrome, Edge, and Safari */
* {
    scrollbar-width: thin; /* Firefox */
    scrollbar-color: #777676 #5c5b5b; /* Firefox: thumb and track */
}
...
<CodeBlox>
	...
	<!-- PREVIEW -->
	<div slot="preview" class={codeblock}>nutting 2 c hier, look rite</div>
