<script lang="ts">
	...
	const tabsSvelte4 = [
		{
			title: '+page.svelte',
			code: `const imgUrls = ['/favicon.png', '/github.png'];
...
<div class="transition-all duration-500 ease-in-out" style={img} />`
	...
	let imgChangeInterval: number | undefined;
...
<CodeBlox>
	...
	<!-- PREVIEW -->
	<div slot="preview" class="{codeblock} transition-all duration-500 ease-in-out h-80" style={img}></div>
